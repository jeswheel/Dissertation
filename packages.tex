...
\usepackage{caption}
\RequirePackage{amsthm,xr,lmodern}
\usepackage{makecell}
\usepackage{multirow}
\usepackage{multicol}
\usepackage{bm}
...
\newcolumntype{L}[1]{>{\raggedright\arraybackslash}m{#1}} % Custom column type for left-aligned text
\newcolumntype{C}[1]{>{\centering\arraybackslash}m{#1}} % Custom column type for centered text
